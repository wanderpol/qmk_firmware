...
combo_t key_combos[] = {
  ...
  [FL_Q] = COMBO(fl_combo, KC_Q),
  [LD_P] = COMBO(ld_combo, KC_P),
  [HG_X] = COMBO(hg_combo, KC_X),
  [JSlash_Z] = COMBO(jslash_combo, KC_Z),
//   [OY_Q] = COMBO(oy_combo, KC_W)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_LALT,KC_QUOTE,    KC_B,    KC_H,    KC_G,LSFT(KC_QUOTE),                KC_SCLN,  KC_DOT,KC_SLASH,    KC_J,    KC_X, KC_SCRL,
  //               '         ㅠ   ㅂ   ㅗ     ㅌ   ㅎ     "                             ;       .         /        ㅓ    ㅋ    ㅋ
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LGUI, HR_C_LG, HR_C_LA, HR_C_LC, HR_C_LS,    KC_K,                     KC_COMMA, HR_C_RS, HR_C_RC, HR_C_RA, HR_C_RG,   DF(1),
  //              c ㅊ     s ㄴ     n ㅜ      t ㅅ      ㅏ                             ,       a ㅁ      e ㄷ      i ㅑ     m ㅡ
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL,KC_EQUAL,    KC_F,    KC_L,    KC_D,    KC_V,                     KC_MINUS,    KC_U,    KC_O,    KC_Y,    KC_W, KC_RALT,
  //               =         ㄹ   ㅔ   ㅣ       ㅇ       ㅍ                            -        ㅕ       ㅐ        ㅛ    ㅈ    ㅈ
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        //   QK_GESC,TD(TD_L2),TD(TD_L1), TD(TD_R1),TD(TD_R2),TD(TD_R3)
                                          QK_GESC,TD(TD_L2),TD(TD_L1), TD(TD_R1),TD(TD_R2),KC_BSPC
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, HR_Q_LG, HR_Q_LA, HR_Q_LC, HR_Q_LS,    KC_G,                         KC_H, HR_Q_RS, HR_Q_RC, HR_Q_RA, HR_Q_RG,   DF(0),
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS,KC_GRAVE,    KC_4,    KC_5,    KC_6, KC_EQUAL,                     MS_BTN2, MS_LEFT, MS_DOWN,   MS_UP, MS_RGHT,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS,KC_QUOTE,    KC_1,    KC_2,    KC_3, KC_BSLS,                      MS_BTN1, MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_TRNS, LSFT(KC_LBRC), LSFT(KC_7), LSFT(KC_8), LSFT(KC_9), LSFT(KC_RBRC),   KC_NO,   KC_F7,   KC_F8,   KC_F9,  KC_F12,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, LSFT(KC_GRAVE), LSFT(KC_4), LSFT(KC_5), LSFT(KC_6),LSFT(KC_EQUAL),  KC_NO,   KC_F4,   KC_F5,   KC_F6,  KC_F11,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, LSFT(KC_QUOTE), LSFT(KC_1), LSFT(KC_2), LSFT(KC_3),LSFT(KC_BSLS),   KC_NO,   KC_F1,   KC_F2,   KC_F3,  KC_F10,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_TRNS, LGUI(KC_Q), LGUI(KC_W), LGUI(KC_E), LGUI(KC_R), LGUI(KC_T),     KC_INSERT, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, LGUI(KC_A), LGUI(KC_S), LGUI(KC_D), LGUI(KC_F), LGUI(KC_G),       KC_CAPS, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_B),        KC_DEL, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT,   KC_NO,                        KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,   KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            KC_NO,   KC_NO,   KC_NO,    KC_BTN1, KC_BTN3, KC_BTN2
